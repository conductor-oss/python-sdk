...
class TestCredentialExceptions:
    ...
    def test_credential_not_found_error_is_conductor_agent_error(self):
        exc = CredentialNotFoundError(["GITHUB_TOKEN"])
        assert isinstance(exc, ConductorAgentError)
    ...
    def test_credential_auth_error_is_conductor_agent_error(self):
    ...
    def test_credential_rate_limit_error_is_conductor_agent_error(self):
        exc = CredentialRateLimitError()
        assert isinstance(exc, ConductorAgentError)

    def test_credential_service_error_is_conductor_agent_error(self):

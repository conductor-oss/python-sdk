...
def _load_example():
    ...
    # __file__ → conductor-python/tests/ai/unit/test_example_109_replan_loop.py
    # parents[3] → conductor-python (the directory containing examples/).
    py_root = Path(__file__).resolve().parents[3]
    src = py_root / "examples" / "agents" / "109_plan_execute_replan.py"

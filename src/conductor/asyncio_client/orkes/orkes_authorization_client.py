...
class OrkesAuthorizationClient(OrkesBaseClient):
    ...
    async def create_user(
        ...
        """Create a new user"""
        return await self.userResourceApi.upsert_user(
    ...
    async def get_user(self, user_id: str) -> ConductorUserAdapter:
        """Get user by ID"""
        return await self.userResourceApi.get_user(id=user_id)

    async def delete_user(self, user_id: str) -> None:
        """Delete user by ID"""
        await self.userResourceApi.delete_user(id=user_id)

    async def list_users(
        self, include_apps: bool = False
    ) -> List[ConductorUserAdapter]:
        """List all users"""
        return await self.userResourceApi.list_users(apps=include_apps)
    ...
    async def create_application(
        ...
        return await self.applicationResourceApi.create_application(
    ...
    async def update_application(
        ...
        return await self.applicationResourceApi.update_application(
    ...
    async def get_application(
        ...
        return await self.applicationResourceApi.get_application(id=application_id)

    async def delete_application(self, application_id: str) -> None:
        """Delete application by ID"""
        await self.applicationResourceApi.delete_application(id=application_id)

    async def list_applications(self) -> List[ExtendedConductorApplicationAdapter]:
        """List all applications"""
        return await self.applicationResourceApi.list_applications()
    ...
    async def create_group(
        ...
        """Create a new group"""
        return await self.groupResourceApi.upsert_group(
    ...
    async def get_group(self, group_id: str) -> GroupAdapter:
        """Get group by ID"""
        return await self.groupResourceApi.get_group(id=group_id)

    async def delete_group(self, group_id: str) -> None:
        """Delete group by ID"""
        await self.groupResourceApi.delete_group(id=group_id)

    async def list_groups(self) -> List[GroupAdapter]:
        """List all groups"""
        return await self.groupResourceApi.list_groups()

    # Group User Management Operations
    async def add_user_to_group(self, group_id: str, user_id: str) -> object:
        """Add a user to a group"""
        return await self.groupResourceApi.add_user_to_group(
            group_id=group_id, user_id=user_id
        )

    async def remove_user_from_group(self, group_id: str, user_id: str) -> object:
        """Remove a user from a group"""
        return await self.groupResourceApi.remove_user_from_group(
            group_id=group_id, user_id=user_id
        )

    async def add_users_to_group(self, group_id: str, user_ids: List[str]) -> object:
        """Add multiple users to a group"""
        return await self.groupResourceApi.add_users_to_group(
    ...
    async def remove_users_from_group(
        ...
        return await self.groupResourceApi.remove_users_from_group(
            group_id=group_id, request_body=user_ids
        )

    async def get_users_in_group(self, group_id: str) -> object:
        """Get all users in a group"""
        return await self.groupResourceApi.get_users_in_group(id=group_id)
    ...
    async def grant_permissions(
        ...
        return await self.authorizationResourceApi.grant_permissions(
    ...
    async def remove_permissions(
        ...
        return await self.authorizationResourceApi.remove_permissions(
            authorization_request=authorization_request
        )
    ...
    async def get_permissions(self, entity_type: str, entity_id: str) -> object:
        ...
        return await self.authorizationResourceApi.get_permissions(
            type=entity_type, id=entity_id
        )

    async def get_group_permissions(self, group_id: str) -> object:
        """Get permissions granted to a group"""
        return await self.groupResourceApi.get_granted_permissions1(group_id=group_id)

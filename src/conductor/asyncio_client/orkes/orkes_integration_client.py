...
class OrkesIntegrationClient(OrkesBaseClient):
    ...
    async def save_integration_provider(
        ...
        await self.integrationApi.save_integration_provider(name, integration_update)

    async def get_integration_provider(self, name: str) -> IntegrationDefAdapter:
        """Get integration provider by name"""
        return await self.integrationApi.get_integration_provider(name)

    async def delete_integration_provider(self, name: str) -> None:
        """Delete an integration provider"""
        await self.integrationApi.delete_integration_provider(name)
    ...
    async def get_integration_providers(
        ...
        return await self.integrationApi.get_integration_providers(
    ...
    async def get_integration_provider_defs(
        ...
        return await self.integrationApi.get_integration_provider_defs(name)
    ...
    async def get_providers_and_integrations(
        ...
        return await self.integrationApi.get_providers_and_integrations(
    ...
    async def put_tag_for_integration(
        ...
        await self.integrationApi.put_tag_for_integration(
    ...
    async def get_tags_for_integration(
        ...
        return await self.integrationApi.get_tags_for_integration(
    ...
    async def delete_tag_for_integration(
        ...
        await self.integrationApi.delete_tag_for_integration(
            name=name, integration_name=integration_name, tag=tags
        )

    async def put_tag_for_integration_provider(
        self, body: List[TagAdapter], name: str
    ) -> None:
        """Add tags to an integration provider"""
        await self.integrationApi.put_tag_for_integration_provider(body, name)

    async def get_tags_for_integration_provider(self, name: str) -> List[TagAdapter]:
        """Get tags for an integration provider"""
        return await self.integrationApi.get_tags_for_integration_provider(name)

    async def delete_tag_for_integration_provider(
        self, body: List[TagAdapter], name: str
    ) -> None:
        """Delete tags from an integration provider"""
        await self.integrationApi.delete_tag_for_integration_provider(body, name)
    ...
    async def get_token_usage_for_integration(
        ...
        return await self.integrationApi.get_token_usage_for_integration(
            name, integration_name
        )

    async def get_token_usage_for_integration_provider(self, name: str) -> int:
        """Get token usage for an integration provider"""
        return await self.integrationApi.get_token_usage_for_integration_provider(name)

    async def register_token_usage(
        self, name: str, integration_name: str, tokens: int
    ) -> None:
        """Register token usage for an integration"""
        await self.integrationApi.register_token_usage(name, integration_name, tokens)
    ...
    async def associate_prompt_with_integration(
        ...
        await self.integrationApi.associate_prompt_with_integration(
    ...
    async def get_prompts_with_integration(
        ...
        return await self.integrationApi.get_prompts_with_integration(
            integration_provider, integration_name
        )

    # Event and Statistics Operations
    async def record_event_stats(
        self, event_type: str, event_log: List[EventLogAdapter]
    ) -> None:
        """Record event statistics"""
        await self.integrationApi.record_event_stats(
            type=event_type, event_log=event_log
        )
    ...
    async def get_integration_by_category(
        ...
        return await self.get_all_integrations(
            category=category, active_only=active_only
        )

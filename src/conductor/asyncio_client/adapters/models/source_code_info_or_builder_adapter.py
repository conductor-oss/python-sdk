...
from conductor.asyncio_client.adapters.models.location_or_builder_adapter import LocationOrBuilderAdapter
...
class SourceCodeInfoOrBuilderAdapter(SourceCodeInfoOrBuilder):
    ...
    location_or_builder_list: Optional[List[LocationOrBuilderAdapter]] = Field(default=None, alias="locationOrBuilderList")

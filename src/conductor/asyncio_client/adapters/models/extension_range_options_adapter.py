...
from conductor.asyncio_client.adapters.models.declaration_or_builder_adapter import DeclarationOrBuilderAdapter
...
class ExtensionRangeOptionsAdapter(ExtensionRangeOptions):
    ...
    declaration_or_builder_list: Optional[List[DeclarationOrBuilderAdapter]] = Field(default=None, alias="declarationOrBuilderList")
    default_instance_for_type: Optional[ExtensionRangeOptionsAdapter] = Field(default=None, alias="defaultInstanceForType")

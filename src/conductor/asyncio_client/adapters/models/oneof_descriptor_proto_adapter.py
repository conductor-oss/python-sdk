...
from conductor.asyncio_client.adapters.models.oneof_options_adapter import OneofOptionsAdapter
from conductor.asyncio_client.adapters.models.oneof_options_or_builder_adapter import OneofOptionsOrBuilderAdapter
...
class OneofDescriptorProtoAdapter(OneofDescriptorProto):
    ...
    default_instance_for_type: Optional[OneofDescriptorProtoAdapter] = Field(default=None, alias="defaultInstanceForType")

...
from conductor.asyncio_client.adapters.models.message_lite_adapter import MessageLiteAdapter
...
class MessageAdapter(Message):
    ...
    default_instance_for_type: Optional[MessageLiteAdapter] = Field(default=None, alias="defaultInstanceForType")

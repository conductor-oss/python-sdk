...
from conductor.asyncio_client.http.models import ServiceDescriptorProto
from conductor.asyncio_client.adapters.models.descriptor_adapter import DescriptorAdapter
from conductor.asyncio_client.adapters.models.method_descriptor_proto_adapter import MethodDescriptorProtoAdapter
...
from conductor.asyncio_client.adapters.models.service_options_or_builder_adapter import ServiceOptionsOrBuilderAdapter
...
class ServiceDescriptorProtoAdapter(ServiceDescriptorProto):
    ...
    default_instance_for_type: Optional[ServiceDescriptorProtoAdapter] = Field(default=None, alias="defaultInstanceForType")
    ...
    method_or_builder_list: Optional[List[MethodDescriptorProtoOrBuilderAdapter]] = Field(default=None, alias="methodOrBuilderList")

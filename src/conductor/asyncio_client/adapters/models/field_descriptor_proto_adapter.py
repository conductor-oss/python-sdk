...
class FieldDescriptorProtoAdapter(FieldDescriptorProto):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultInstanceForType": FieldDescriptorProtoAdapter.from_dict(obj["defaultInstanceForType"]) if obj.get("defaultInstanceForType") is not None else None,
            "defaultValue": obj.get("defaultValue"),
            "defaultValueBytes": ByteStringAdapter.from_dict(obj["defaultValueBytes"]) if obj.get("defaultValueBytes") is not None else None,
            ...
            "extendeeBytes": ByteStringAdapter.from_dict(obj["extendeeBytes"]) if obj.get("extendeeBytes") is not None else None,
            "initializationErrorString": obj.get("initializationErrorString"),
            "initialized": obj.get("initialized"),
            "jsonName": obj.get("jsonName"),
            "jsonNameBytes": ByteStringAdapter.from_dict(obj["jsonNameBytes"]) if obj.get("jsonNameBytes") is not None else None,
            "label": obj.get("label"),
            ...
            "optionsOrBuilder": FieldOptionsOrBuilderAdapter.from_dict(obj["optionsOrBuilder"]) if obj.get("optionsOrBuilder") is not None else None,
            ...
            "typeNameBytes": ByteStringAdapter.from_dict(obj["typeNameBytes"]) if obj.get("typeNameBytes") is not None else None,

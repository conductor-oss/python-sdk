...
class SecretResourceApiAdapter:
    ...
    async def clear_local_cache(
        ...
        """Clear local cache"""
        return await self._api.clear_local_cache(
    ...
    async def clear_redis_cache(
        ...
        """Clear redis cache"""
        return await self._api.clear_redis_cache(
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def delete_secret(
        ...
        return await self._api.delete_secret(
            key,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def secret_exists(
        ...
        return await self._api.secret_exists(
            key,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def list_all_secret_names(
        ...
        return await self._api.list_all_secret_names(
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def list_secrets_with_tags_that_user_can_grant_access_to(
        ...
        result = await self._api.list_secrets_with_tags_that_user_can_grant_access_to(
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        return convert_list_to_adapter(result, ExtendedSecretAdapter)
    ...
    async def put_secret(
        ...
        return await self._api.put_secret(
            key,
            body,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
    ...
    async def put_tag_for_secret(
        ...
        await self._api.put_tag_for_secret(
            key,
            tag,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
    ...
    async def get_tags(
        ...
        result = await self._api.get_tags(
            key,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def delete_tag_for_secret(
        ...
        return await self._api.delete_tag_for_secret(
            key,
            tag,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
    ...
    async def get_secret(
        ...
        result = await self._api.get_secret(
            key,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def list_secrets_that_user_can_grant_access_to(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        return await self._api.list_secrets_that_user_can_grant_access_to(
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,

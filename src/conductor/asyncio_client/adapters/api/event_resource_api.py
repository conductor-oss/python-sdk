...
class EventResourceApiAdapter:
    ...
    async def add_event_handler(
        ...
        await self._api.add_event_handler(
            event_handler,
    ...
    async def delete_queue_config(
        ...
        """Delete queue config"""
        await self._api.delete_queue_config(
            queue_type,
            queue_name,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
    ...
    async def delete_tag_for_event_handler(
        self,
        name: StrictStr,
        tag: List[TagAdapter],
        _request_timeout: Union[
        ...
        await self._api.delete_tag_for_event_handler(
            name,
            tag,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
    ...
    async def get_event_handler_by_name(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
        ...
        result = await self._api.get_event_handler_by_name(
            name,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        return convert_to_adapter(result, EventHandlerAdapter)
    ...
    async def get_event_handlers(
        ...
        result = await self._api.get_event_handlers(
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        return convert_list_to_adapter(result, EventHandlerAdapter)

    async def get_event_handlers_for_event(
        self,
        event: StrictStr,
        ...
        result = await self._api.get_event_handlers_for_event(
            event,
            active_only,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
    ...
    async def get_queue_config(
        ...
        """Get queue config"""
        return await self._api.get_queue_config(
            queue_type,
            queue_name,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
    ...
    async def get_queue_names(
        ...
        return await self._api.get_queue_names(
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_tags_for_event_handler(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
        ...
        """Get tags for event handler"""
        result = await self._api.get_tags_for_event_handler(
            name,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def handle_incoming_event(
        ...
        await self._api.handle_incoming_event(
            request_body,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def put_queue_config(
        ...
        """(Deprecated) Put queue config"""
        await self._api.put_queue_config(
            queue_type,
            queue_name,
            body,
            _request_timeout=_request_timeout,
    ...
    async def put_tag_for_event_handler(
        self,
        name: StrictStr,
        tag: List[TagAdapter],
        _request_timeout: Union[
        ...
        """Put a tag for event handler"""
        await self._api.put_tag_for_event_handler(
            name,
            tag,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
    ...
    async def remove_event_handler_status(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
        ...
        await self._api.remove_event_handler_status(
            name,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def test_connectivity(
        ...
        result = await self._api.test_connectivity(
        ...
        return convert_to_adapter(result, ConnectivityTestResultAdapter)
    ...
    async def update_event_handler(
        ...
        await self._api.update_event_handler(
            event_handler,
            _request_timeout=_request_timeout,
            _request_auth=_request_auth,
            _content_type=_content_type,

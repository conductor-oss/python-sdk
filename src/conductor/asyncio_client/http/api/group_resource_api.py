...
class GroupResourceApi:
    ...
    @validate_call
    async def add_user_to_group_with_http_info(
        self,
        group_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def add_user_to_group_without_preload_content(
        self,
        group_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def add_users_to_group_with_http_info(
        self,
        group_id: StrictStr,
        request_body: List[StrictStr],
        _request_timeout: Union[
    ...
    @validate_call
    async def add_users_to_group_without_preload_content(
        self,
        group_id: StrictStr,
        request_body: List[StrictStr],
        _request_timeout: Union[
    ...
    async def get_granted_permissions1(
        ...
        _param = self._get_granted_permissions1_serialize(
            group_id=group_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_granted_permissions1_with_http_info(
        self,
        group_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GrantedAccessResponse]:
        """Get the permissions this group has over workflows and tasks
    ...
    @validate_call
    async def get_granted_permissions1_without_preload_content(
        self,
        group_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_granted_permissions1_serialize(
        self,
        group_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def get_users_in_group_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_users_in_group_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def remove_user_from_group_with_http_info(
        self,
        group_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def remove_user_from_group_without_preload_content(
        self,
        group_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def remove_users_from_group_with_http_info(
        self,
        group_id: StrictStr,
        request_body: List[StrictStr],
        _request_timeout: Union[
    ...
    @validate_call
    async def remove_users_from_group_without_preload_content(
        self,
        group_id: StrictStr,
        request_body: List[StrictStr],
        _request_timeout: Union[
    ...
    async def upsert_group(
        self,
        id: StrictStr,
        upsert_group_request: UpsertGroupRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param upsert_group_request: (required)
        :type upsert_group_request: UpsertGroupRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._upsert_group_serialize(
            id=id,
    ...
    @validate_call
    async def upsert_group_with_http_info(
        self,
        id: StrictStr,
        upsert_group_request: UpsertGroupRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def upsert_group_without_preload_content(
        self,
        id: StrictStr,
        upsert_group_request: UpsertGroupRequest,
        _request_timeout: Union[
    ...
    def _upsert_group_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if upsert_group_request is not None:
            _body_params = upsert_group_request

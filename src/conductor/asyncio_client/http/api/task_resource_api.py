...
class TaskResourceApi:
    ...
    @validate_call
    async def all_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def all_verbose(
        ...
        _param = self._all_verbose_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Dict[str, Dict[str, Dict[str, int]]]",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    async def all_verbose_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Dict[str, Dict[str, Dict[str, int]]]]:
        """Get the details about each queue
    ...
    @validate_call
    async def all_verbose_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def batch_poll(
        ...
        _param = self._batch_poll_serialize(
            tasktype=tasktype,
            workerid=workerid,
            domain=domain,
            count=count,
    ...
    @validate_call
    async def batch_poll_with_http_info(
        self,
        tasktype: StrictStr,
        workerid: Optional[StrictStr] = None,
        domain: Optional[StrictStr] = None,
    ...
    @validate_call
    async def batch_poll_without_preload_content(
        self,
        tasktype: StrictStr,
        workerid: Optional[StrictStr] = None,
        domain: Optional[StrictStr] = None,
    ...
    def _batch_poll_serialize(
        ...
        if workerid is not None:
            ...
            _query_params.append(('workerid', workerid))
    ...
    async def get_all_poll_data(
        ...
        :param queue_opt:
        :type queue_opt: str
        :param last_poll_time_size:
        :type last_poll_time_size: int
        :param last_poll_time_opt:
        :type last_poll_time_opt: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_all_poll_data_serialize(
    ...
    @validate_call
    async def get_all_poll_data_with_http_info(
        self,
        worker_size: Optional[StrictInt] = None,
        worker_opt: Optional[StrictStr] = None,
        queue_size: Optional[StrictInt] = None,
    ...
    @validate_call
    async def get_all_poll_data_without_preload_content(
        self,
        worker_size: Optional[StrictInt] = None,
        worker_opt: Optional[StrictStr] = None,
        queue_size: Optional[StrictInt] = None,
    ...
    def _get_all_poll_data_serialize(
        self,
        worker_size,
        worker_opt,
        queue_size,
        ...
        if worker_size is not None:
            ...
            _query_params.append(('workerSize', worker_size))
            
        if worker_opt is not None:
            
            _query_params.append(('workerOpt', worker_opt))
            
        if queue_size is not None:
            
            _query_params.append(('queueSize', queue_size))
            
        if queue_opt is not None:
            
            _query_params.append(('queueOpt', queue_opt))
            
        if last_poll_time_size is not None:
            
            _query_params.append(('lastPollTimeSize', last_poll_time_size))
            
        if last_poll_time_opt is not None:
            
            _query_params.append(('lastPollTimeOpt', last_poll_time_opt))
    ...
    async def get_poll_data(
        ...
        _param = self._get_poll_data_serialize(
            task_type=task_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_poll_data_with_http_info(
        self,
        task_type: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_poll_data_without_preload_content(
        self,
        task_type: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_task_logs_with_http_info(
        self,
        task_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_task_logs_without_preload_content(
        self,
        task_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def log_without_preload_content(
        self,
        task_id: StrictStr,
        body: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def poll_without_preload_content(
        self,
        tasktype: StrictStr,
        workerid: Optional[StrictStr] = None,
        domain: Optional[StrictStr] = None,
    ...
    async def requeue_pending_task(
        ...
        _param = self._requeue_pending_task_serialize(
            task_type=task_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def requeue_pending_task_with_http_info(
        self,
        task_type: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def requeue_pending_task_without_preload_content(
        self,
        task_type: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _requeue_pending_task_serialize(
        self,
        task_type,
        _request_auth,
        _content_type,
    ...
    async def search1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchResultTaskSummary]:
        """Search for tasks based in payload and other parameters
    ...
    @validate_call
    async def size_without_preload_content(
        self,
        task_type: Optional[List[StrictStr]] = None,
        _request_timeout: Union[
            None,
    ...
    async def update_task1(
        ...
        _param = self._update_task1_serialize(
    ...
    @validate_call
    async def update_task1_with_http_info(
        self,
        workflow_id: StrictStr,
        task_ref_name: StrictStr,
        status: StrictStr,
    ...
    @validate_call
    async def update_task1_without_preload_content(
        self,
        workflow_id: StrictStr,
        task_ref_name: StrictStr,
        status: StrictStr,
    ...
    @validate_call
    async def update_task_sync_with_http_info(
        self,
        workflow_id: StrictStr,
        task_ref_name: StrictStr,
        status: StrictStr,
    ...
    @validate_call
    async def update_task_sync_without_preload_content(
        self,
        workflow_id: StrictStr,
        task_ref_name: StrictStr,
        status: StrictStr,
    ...
    def _update_task_sync_serialize(
        self,
        workflow_id,
        task_ref_name,
        status,

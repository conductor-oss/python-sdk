...
class AdminResourceApi:
    ...
    async def clear_task_execution_cache(
        ...
        :param task_def_name: (required)
        :type task_def_name: str
        ...
        _param = self._clear_task_execution_cache_serialize(
    ...
    @validate_call
    async def clear_task_execution_cache_with_http_info(
        self,
        task_def_name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def clear_task_execution_cache_without_preload_content(
        self,
        task_def_name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _clear_task_execution_cache_serialize(
        self,
        task_def_name,
        _request_auth,
        _content_type,
        ...
        if task_def_name is not None:
            _path_params['taskDefName'] = task_def_name
    ...
    async def get_redis_usage(
        ...
        _param = self._get_redis_usage_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_redis_usage_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_redis_usage_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_redis_usage_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    async def requeue_sweep(
        ...
        _param = self._requeue_sweep_serialize(
    ...
    @validate_call
    async def requeue_sweep_with_http_info(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def requeue_sweep_without_preload_content(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    async def verify_and_repair_workflow_consistency(
        ...
        _param = self._verify_and_repair_workflow_consistency_serialize(
            workflow_id=workflow_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def verify_and_repair_workflow_consistency_with_http_info(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def verify_and_repair_workflow_consistency_without_preload_content(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _verify_and_repair_workflow_consistency_serialize(
        self,
        workflow_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def view_without_preload_content(
        self,
        tasktype: StrictStr,
        start: Optional[StrictInt] = None,
        count: Optional[StrictInt] = None,

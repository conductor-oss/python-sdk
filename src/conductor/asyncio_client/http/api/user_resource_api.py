...
class UserResourceApi:
    ...
    @validate_call
    async def check_permissions_with_http_info(
        self,
        user_id: StrictStr,
        type: StrictStr,
        id: StrictStr,
    ...
    @validate_call
    async def check_permissions_without_preload_content(
        self,
        user_id: StrictStr,
        type: StrictStr,
        id: StrictStr,
    ...
    async def get_granted_permissions(
        ...
        _param = self._get_granted_permissions_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_granted_permissions_with_http_info(
        self,
        user_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_granted_permissions_without_preload_content(
        self,
        user_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_granted_permissions_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
    ...
    async def list_users_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ConductorUser]]:
        """Get all users
    ...
    async def upsert_user(
        ...
        :param id: (required)
        :type id: str
        :param upsert_user_request: (required)
        :type upsert_user_request: UpsertUserRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._upsert_user_serialize(
            id=id,
            upsert_user_request=upsert_user_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def upsert_user_with_http_info(
        self,
        id: StrictStr,
        upsert_user_request: UpsertUserRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def upsert_user_without_preload_content(
        self,
        id: StrictStr,
        upsert_user_request: UpsertUserRequest,
        _request_timeout: Union[
    ...
    def _upsert_user_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if upsert_user_request is not None:
            _body_params = upsert_user_request

...
class TokenResourceApi:
    ...
    async def generate_token(
        ...
        :param generate_token_request: (required)
    ...
    @validate_call
    async def generate_token_with_http_info(
        self,
        generate_token_request: GenerateTokenRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def generate_token_without_preload_content(
        self,
        generate_token_request: GenerateTokenRequest,
        _request_timeout: Union[
            None,
    ...
    def _generate_token_serialize(
        ...
        if generate_token_request is not None:
            _body_params = generate_token_request
    ...
    def _get_user_info_serialize(
        ...
        if claims is not None:
            ...
            _query_params.append(('claims', claims))

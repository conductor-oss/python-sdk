...
class WorkflowDef(object):
    ...
    def __init__(self, cache_config=None, create_time=None, created_by=None, description=None, enforce_schema=None, failure_workflow=None, input_parameters=None, input_schema=None, input_template=None, metadata=None, name=None, output_parameters=None, output_schema=None, owner_app=None, owner_email=None, rate_limit_config=None, restartable=None, schema_version=None, tasks=None, timeout_policy=None, timeout_seconds=None, update_time=None, updated_by=None, variables=None, version=None, workflow_status_listener_enabled=None, workflow_status_listener_sink=None):  # noqa: E501

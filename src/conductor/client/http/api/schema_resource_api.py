...
class SchemaResourceApi(object):
    ...
    def delete_schema_by_name_and_version_with_http_info(self, name, version, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/schema/{name}/{version}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_schema_by_name_with_latest_version(self, name, **kwargs):  # noqa: E501
        """Get schema by name with latest version  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_schema_by_name_with_latest_version(name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_schema_by_name_with_latest_version_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_schema_by_name_with_latest_version_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_schema_by_name_with_latest_version_with_http_info(self, name, **kwargs):  # noqa: E501
        """Get schema by name with latest version  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_schema_by_name_with_latest_version_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_schema_by_name_with_latest_version" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_schema_by_name_with_latest_version`")  # noqa: E501

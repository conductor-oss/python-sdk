...
class IntegrationResourceApi(object):
    ...
    def associate_prompt_with_integration_with_http_info(self, integration_provider, integration_name, prompt_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{integration_provider}/integration/{integration_name}/prompt/{prompt_name}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_integration_api_with_http_info(self, name, integration_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/integration/{integration_name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_integration_provider_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_tag_for_integration_with_http_info(self, body, name, integration_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/integration/{integration_name}/tags', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_tag_for_integration_provider_with_http_info(self, body, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/tags', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_integration_api_with_http_info(self, name, integration_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/integration/{integration_name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_integration_apis_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/integration', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_integration_available_apis_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/integration/all', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_integration_def(self, name, **kwargs):  # noqa: E501
        """Get an integration definition  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_integration_def(name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_integration_def_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_integration_def_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_integration_def_with_http_info(self, name, **kwargs):  # noqa: E501
        """Get an integration definition  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_integration_def_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_integration_def" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_integration_def`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='IntegrationDef',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_integration_provider_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_prompts_with_integration_with_http_info(self, integration_provider, integration_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{integration_provider}/integration/{integration_name}/prompt', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_tags_for_integration_with_http_info(self, name, integration_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/integration/{integration_name}/tags', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_tags_for_integration_provider_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/tags', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def put_tag_for_integration_with_http_info(self, body, name, integration_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/integration/{integration_name}/tags', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def put_tag_for_integration_provider_with_http_info(self, body, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/tags', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def record_event_stats_with_http_info(self, body, type, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/eventStats/{type}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def register_integration(self, body, **kwargs):  # noqa: E501
        """upsert an integration definition  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_integration(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[IntegrationDef] body: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.register_integration_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.register_integration_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def register_integration_with_http_info(self, body, **kwargs):  # noqa: E501
        """upsert an integration definition  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_integration_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method register_integration" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `register_integration`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/def/register', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def save_integration_api_with_http_info(self, body, name, integration_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}/integration/{integration_name}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def save_integration_provider_with_http_info(self, body, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/integrations/provider/{name}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

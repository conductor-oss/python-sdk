...
class SecretResourceApi(object):
    ...
    def clear_local_cache_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/secrets/clearLocalCache', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def clear_redis_cache_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/secrets/clearRedisCache', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

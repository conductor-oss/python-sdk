...
class WorkflowResourceApi(object):
    ...
    def execute_workflow(self, body, name, version, **kwargs):  # noqa: E501
        """Execute a workflow synchronously  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.execute_workflow(body, name, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.execute_workflow_with_http_info(body, name, version, **kwargs)  # noqa: E501
        else:
            (data) = self.execute_workflow_with_http_info(body, name, version, **kwargs)  # noqa: E501
            return data

    def execute_workflow_with_http_info(self, body, name, version, **kwargs):  # noqa: E501
        """Execute a workflow synchronously  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.execute_workflow_with_http_info(body, name, version, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/workflow/execute/{name}/{version}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def execute_workflow_as_api_with_http_info(self, body, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/execute/{name}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_execution_status(self, workflow_id, **kwargs):  # noqa: E501
        """Gets the workflow by workflow (execution) id  # noqa: E501
    ...
    def get_execution_status_task_list(self, workflow_id, **kwargs):  # noqa: E501
        """Gets the workflow tasks by workflow (execution) id  # noqa: E501
    ...
    def get_execution_status_task_list_with_http_info(self, workflow_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/{workflowId}/tasks', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_workflow_status_summary_with_http_info(self, workflow_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/{workflowId}/status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_workflows1_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/correlated/batch', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def jump_to_task_with_http_info(self, body, workflow_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/{workflowId}/jump/{taskReferenceName}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search1(self, **kwargs):  # noqa: E501
        """Search for workflow executions based on payload and other parameters  # noqa: E501
    ...
    def start_workflow_async(self, body, name, version, **kwargs):  # noqa: E501
        """Start a new workflow asynchronously. Returns the ID of the workflow instance that can be later used for tracking  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_workflow_async(body, name, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.start_workflow_async_with_http_info(body, name, version, **kwargs)  # noqa: E501
        else:
            (data) = self.start_workflow_async_with_http_info(body, name, version, **kwargs)  # noqa: E501
            return data

    def start_workflow_async_with_http_info(self, body, name, version, **kwargs):  # noqa: E501
        """Start a new workflow asynchronously. Returns the ID of the workflow instance that can be later used for tracking  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_workflow_async_with_http_info(body, name, version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'name', 'version', 'x_idempotency_key', 'x_on_conflict', 'correlation_id', 'priority']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method start_workflow_async" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `start_workflow_async`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `start_workflow_async`")  # noqa: E501
        # verify the required parameter 'version' is set
        if ('version' not in params or
                params['version'] is None):
            raise ValueError("Missing the required parameter `version` when calling `start_workflow_async`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/start/{name}/{version}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_workflow_and_task_state_with_http_info(self, body, request_id, workflow_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/{workflowId}/state', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_workflow_state_with_http_info(self, body, workflow_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/{workflowId}/variables', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def upgrade_running_workflow_to_version_with_http_info(self, body, workflow_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/workflow/{workflowId}/upgrade', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

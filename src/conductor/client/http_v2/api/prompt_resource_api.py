...
class PromptResourceApi(object):
    ...
    def delete_message_template1(self, name, version, **kwargs):  # noqa: E501
        """Delete Template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_message_template1(name, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_message_template1_with_http_info(name, version, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_message_template1_with_http_info(name, version, **kwargs)  # noqa: E501
            return data

    def delete_message_template1_with_http_info(self, name, version, **kwargs):  # noqa: E501
        """Delete Template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_message_template1_with_http_info(name, version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_message_template1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `delete_message_template1`")  # noqa: E501
        # verify the required parameter 'version' is set
        if ('version' not in params or
                params['version'] is None):
            raise ValueError("Missing the required parameter `version` when calling `delete_message_template1`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/prompts/{name}/versions/{version}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_message_template_versions(self, name, **kwargs):  # noqa: E501
        """Get all versions of a Template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_message_template_versions(name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_message_template_versions_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_message_template_versions_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_message_template_versions_with_http_info(self, name, **kwargs):  # noqa: E501
        """Get all versions of a Template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_message_template_versions_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_message_template_versions" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_message_template_versions`")  # noqa: E501
    ...
    def save_message_template_with_http_info(self, body, description, name, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'description', 'name', 'models', 'version', 'auto_increment']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'version' in params:
            query_params.append(('version', params['version']))  # noqa: E501
        if 'auto_increment' in params:
            query_params.append(('autoIncrement', params['auto_increment']))  # noqa: E501
    ...
    def update_message_template(self, body, description, name, **kwargs):  # noqa: E501
        """Create a template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_message_template(body, description, name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_message_template_with_http_info(body, description, name, **kwargs)  # noqa: E501
        else:
            (data) = self.update_message_template_with_http_info(body, description, name, **kwargs)  # noqa: E501
            return data

    def update_message_template_with_http_info(self, body, description, name, **kwargs):  # noqa: E501
        """Create a template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_message_template_with_http_info(body, description, name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'description', 'name', 'version', 'models']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_message_template`")  # noqa: E501
        # verify the required parameter 'description' is set
        if ('description' not in params or
                params['description'] is None):
            raise ValueError("Missing the required parameter `description` when calling `update_message_template`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `update_message_template`")  # noqa: E501

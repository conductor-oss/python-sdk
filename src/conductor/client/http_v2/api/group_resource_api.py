...
class GroupResourceApi(object):
    ...
    def add_user_to_group_with_http_info(self, group_id, user_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/groups/{groupId}/users/{userId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_granted_permissions1_with_http_info(self, group_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/groups/{groupId}/permissions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def remove_user_from_group_with_http_info(self, group_id, user_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/groups/{groupId}/users/{userId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def remove_users_from_group_with_http_info(self, body, group_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/groups/{groupId}/users', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,

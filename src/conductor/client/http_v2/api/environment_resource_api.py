...
class EnvironmentResourceApi(object):
    ...
    def delete_tag_for_env_var_with_http_info(self, body, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/environment/{name}/tags', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get3(self, key, **kwargs):  # noqa: E501
        """Get the environment value by key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get3(key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get3_with_http_info(key, **kwargs)  # noqa: E501
        else:
            (data) = self.get3_with_http_info(key, **kwargs)  # noqa: E501
            return data

    def get3_with_http_info(self, key, **kwargs):  # noqa: E501
        """Get the environment value by key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get3_with_http_info(key, async_req=True)
        >>> result = thread.get()
        ...
        if ('key' not in params or
                params['key'] is None):
            raise ValueError("Missing the required parameter `key` when calling `get3`")  # noqa: E501

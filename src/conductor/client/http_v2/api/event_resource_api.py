...
class EventResourceApi(object):
    ...
    def delete_queue_config_with_http_info(self, queue_type, queue_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/event/queue/config/{queueType}/{queueName}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_queue_config_with_http_info(self, queue_type, queue_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/event/queue/config/{queueType}/{queueName}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def handle_incoming_event_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/event/handleIncomingEvent', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def put_queue_config_with_http_info(self, body, queue_type, queue_name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/event/queue/config/{queueType}/{queueName}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def test_connectivity_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/event/queue/connectivity', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

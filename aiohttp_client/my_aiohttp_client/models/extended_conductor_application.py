...
class ExtendedConductorApplication(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createTime", "createdBy", "id", "name", "tags", "updateTime", "updatedBy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedConductorApplication from a JSON string"""

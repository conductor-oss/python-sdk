...
class ApplicationResourceApi:
    ...
    async def add_role_to_application_user(
        ...
        _param = self._add_role_to_application_user_serialize(
    ...
    @validate_call
    async def add_role_to_application_user_with_http_info(
        self,
        application_id: StrictStr,
        role: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def add_role_to_application_user_without_preload_content(
        self,
        application_id: StrictStr,
        role: StrictStr,
        _request_timeout: Union[
    ...
    def _add_role_to_application_user_serialize(
        self,
        application_id,
        role,
        _request_auth,
    ...
    @validate_call
    async def create_access_key_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_access_key_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    async def create_application(
        ...
        :param create_or_update_application_request: (required)
        :type create_or_update_application_request: CreateOrUpdateApplicationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _create_application_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_or_update_application_request is not None:
            _body_params = create_or_update_application_request
    ...
    @validate_call
    async def delete_access_key_with_http_info(
        self,
        application_id: StrictStr,
        key_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def delete_access_key_without_preload_content(
        self,
        application_id: StrictStr,
        key_id: StrictStr,
        _request_timeout: Union[
    ...
    async def delete_tag_for_application(
        ...
        _param = self._delete_tag_for_application_serialize(
            id=id,
            tag=tag,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def delete_tag_for_application_with_http_info(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
    ...
    @validate_call
    async def delete_tag_for_application_without_preload_content(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
    ...
    def _delete_tag_for_application_serialize(
        self,
        id,
        tag,
        _request_auth,
    ...
    @validate_call
    async def get_access_keys_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_access_keys_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    async def get_app_by_access_key_id(
        ...
        _param = self._get_app_by_access_key_id_serialize(
    ...
    @validate_call
    async def get_app_by_access_key_id_with_http_info(
        self,
        access_key_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_app_by_access_key_id_without_preload_content(
        self,
        access_key_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_app_by_access_key_id_serialize(
        self,
        access_key_id,
        _request_auth,
        _content_type,
    ...
    async def get_tags_for_application(
        ...
        _param = self._get_tags_for_application_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_tags_for_application_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_tags_for_application_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_tags_for_application_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    async def list_applications(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ExtendedConductorApplication]",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    async def list_applications_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ExtendedConductorApplication]]:
        """Get all applications
    ...
    async def put_tag_for_application(
        ...
        _param = self._put_tag_for_application_serialize(
            id=id,
            tag=tag,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def put_tag_for_application_with_http_info(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
    ...
    @validate_call
    async def put_tag_for_application_without_preload_content(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
    ...
    def _put_tag_for_application_serialize(
        self,
        id,
        tag,
        _request_auth,
    ...
    async def remove_role_from_application_user(
        ...
        _param = self._remove_role_from_application_user_serialize(
            application_id=application_id,
            role=role,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def remove_role_from_application_user_with_http_info(
        self,
        application_id: StrictStr,
        role: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def remove_role_from_application_user_without_preload_content(
        self,
        application_id: StrictStr,
        role: StrictStr,
        _request_timeout: Union[
    ...
    def _remove_role_from_application_user_serialize(
        self,
        application_id,
        role,
        _request_auth,
    ...
    async def toggle_access_key_status(
        ...
        _param = self._toggle_access_key_status_serialize(
            application_id=application_id,
            key_id=key_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def toggle_access_key_status_with_http_info(
        self,
        application_id: StrictStr,
        key_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def toggle_access_key_status_without_preload_content(
        self,
        application_id: StrictStr,
        key_id: StrictStr,
        _request_timeout: Union[
    ...
    def _toggle_access_key_status_serialize(
        self,
        application_id,
        key_id,
        _request_auth,
